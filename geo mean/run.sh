...
#License: GPL3, and open source license for software.
...
gcc -c -m64 -Wall -fno-pie -no-pie -o geometric-main.o geometric-main.c

echo "Compile the C++ file fill_array.cpp"
g++ -c -m64 -Wall -fno-pie -no-pie -o fill.o fill_array.cpp

echo "Compile the C file display.c"
gcc -c -m64 -Wall -fno-pie -no-pie -o display.o display.c

echo "Link the 'O' files arrays-main.o and arrays-x86.o"
g++ -m64 -fno-pie -no-pie -o har.out geometric-main.o control.o fill.o display.o
