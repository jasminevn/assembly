...
//Program title: Assembly Language
//Files in this program: robot.cpp, doingmath.cpp, core.sh
...
//Compile this module: robot.cpp
//Link object files: robot.cpp, doingmath.cpp
//Execute:
...
int main(){
  ...
  printf("%s","Welcome to Assembly Language. \n");
